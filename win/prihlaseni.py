...
class Ui_prihlaseni(object):
    ...
    def setupUi(self, prihlaseni):
        ...
        self.formLayout.setItem(2, QtWidgets.QFormLayout.ItemRole.SpanningRole, spacerItem3)
        spacerItem4 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Minimum,
                                            QtWidgets.QSizePolicy.Policy.Minimum)
        self.formLayout.setItem(7, QtWidgets.QFormLayout.ItemRole.SpanningRole, spacerItem4)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.chybHlaska)
